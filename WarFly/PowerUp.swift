...
class PowerUp: SKSpriteNode {
    ...
    fileprivate var textureNameBeginesWith = ""
    ...
    init(textureAtlas: SKTextureAtlas){
        ...
        textureNameBeginesWith = String(textureName.characters.dropLast(6))
    ...
    func startMovement() {
        ...
        let moveForward = SKAction.moveTo(y: -130, duration: 5)
    ...
    fileprivate func performRotation() {
        for i in 1...15 {
            ...
            animationSpriteArray.append(SKTexture(imageNamed: textureNameBeginesWith + number.description))
        }
